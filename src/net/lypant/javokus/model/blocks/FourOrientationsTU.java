...
public class FourOrientationsTU implements Transformation
{
    ...
    public void reflect()
    {
        ...
        {
            case NORMAL_0:      break;
            case NORMAL_90:     orientation =   NORMAL_270; break;
            case NORMAL_180:    break;
            case NORMAL_270:    orientation =   NORMAL_90;  break;
            default: assert false : "Unhandled orientation: " + orientation; break;
        }
    }
}
